...
ESTADOS_SERVICIO = [
    ...
    'EN_PROCESO', 
    'ESPERA_REPUESTOS',
    'ESPERA_CONFIRMACION_CLIENTE',  # Nuevo estado
...
ESTADOS_PERMITIDOS = {
    ...
    'EN_PROCESO': ['ESPERA_REPUESTOS', 'ESPERA_CONFIRMACION_CLIENTE', 'A_FACTURAR', 'COMPLETADO'],
    'ESPERA_REPUESTOS': ['EN_PROCESO', 'ESPERA_CONFIRMACION_CLIENTE', 'A_FACTURAR', 'COMPLETADO'],
    'ESPERA_CONFIRMACION_CLIENTE': ['EN_PROCESO', 'A_FACTURAR', 'COMPLETADO'],
